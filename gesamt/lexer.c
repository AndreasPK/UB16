...
YY_RULE_SETUP
#line 176 "oxout.l"
{yyyGenLeaf(1,7,yyyLRCIL+0,yyyLRCIL+1); (((yyyP7)(yyyTermBuffer.snBufPtr))->name) = strdup(yytext); return ID;} 
	YY_BREAK
case 23:
YY_RULE_SETUP
#line 177 "oxout.l"
{yyyGenLeaf(1,6,yyyLRCIL+1,yyyLRCIL+2); (((yyyP6)(yyyTermBuffer.snBufPtr))->value) = atol(yytext); return NUMBER;}  //printf("num %ld\n", atol(yytext));
	YY_BREAK
case 24:
YY_RULE_SETUP
#line 178 "oxout.l"
{yyyGenLeaf(1,6,yyyLRCIL+1,yyyLRCIL+2); (((yyyP6)(yyyTermBuffer.snBufPtr))->value) = strtol(yytext+2, NULL, 16); return NUMBER;} 
	YY_BREAK
case 25:
